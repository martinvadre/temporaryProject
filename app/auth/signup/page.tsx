                    ...
                    (
                        <Form {...form}>
                            <form {...form.submitAction(onSubmit)}>
                                ...
                                <CButton isDisabled={(!(password == confirmPassword && !passwordError.isError && form.getValues().name != "" && form.getValues().email != ""))} isLoading={isPending} className="w-full p-[10px] mt-[20px] bg-[#000000] text-white rounded-full text-[16px] cursor-pointer transition ease duration-250 h-auto hover:bg-[#323232]" type="submit">Sign Up</CButton>
                            </form>
                        </Form>
                    )
                }
